<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @endcan
        @can('company_vehicle_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.company-vehicles.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/company-vehicles") || request()->is("admin/company-vehicles/*") ? "c-active" : "" }}">
                    <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">
        ...
        @endcan
        @can('vehicle_document_type_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.vehicle-document-types.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/vehicle-document-types") || request()->is("admin/vehicle-document-types/*") ? "c-active" : "" }}">
                    <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">

                    </i>
                    {{ trans('cruds.vehicleDocumentType.title') }}
                </a>
            </li>
        @endcan
        @can('vehicle_document_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.vehicle-documents.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/vehicle-documents") || request()->is("admin/vehicle-documents/*") ? "c-active" : "" }}">
                    <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">
