...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-companyVehicleExpenses">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($expenses as $key => $expense)
                        <tr data-entry-id="{{ $expense->id }}">
                            ...
                            <td>
                                {{ $expense->company_vehicle->plate_number ?? '' }}
                            </td>
                            <td>
                                {{ $expense->entry_date ?? '' }}
                            </td>
...
@endcan
  ...
  let table = $('.datatable-companyVehicleExpenses:not(.ajaxTable)').DataTable({ buttons: dtButtons })
